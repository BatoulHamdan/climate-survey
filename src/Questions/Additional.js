const Additional = [
    ...
    },
    {
      ...
      question: {
        ...
        fa: "چقدر برای شما مهم است که کشور شما در فناوری‌ها و نوآوری‌های جدید پیشتاز باشد؟",
        fr: "À quel point est-il important pour vous que ce pays soit leader mondial en technologies et innovation ?",
        it: "Quanto è importante per te che questo paese sia leader mondiale in nuove tecnologie e innovazione?"
      },
      options: [
        ...
        { value: "Slightly important", label: { en: "Slightly important", ar: "مهم قليلاً", fa: "کم اهمیت", fr: "Légèrement important", it: "Poco importante" } },
    ...
    },
    {
      ...
      question: {
        ...
        fa: "آیا با این جمله موافقید یا مخالفید: میهن‌دوستی واقعی یعنی ترک کشور در وضعیتی بهتر از آنچه یافتید؟",
        fr: "Êtes-vous d'accord ou non avec l'affirmation : Le véritable patriotisme signifie laisser le pays dans un meilleur état que vous ne l'avez trouvé.",
      ...
      options: [
        ...
        { value: "Somewhat disagree", label: { en: "Somewhat disagree", ar: "أعارض إلى حد ما", fa: "تا حدی مخالفم", fr: "Plutôt en désaccord", it: "Abbastanza in disaccordo" } },
    ...
    },
    {
      ...
      question: {
        ...
        it: "Su questioni sociali e politiche, dove ti collocheresti?"
      },
      options: [
        { value: "Very liberal", label: { en: "Very liberal", ar: "ليبرالي جدًا", fa: "بسیار لیبرال", fr: "Très libéral", it: "Molto liberale" } },
        { value: "Slightly liberal", label: { en: "Slightly liberal", ar: "ليبرالي إلى حد ما", fa: "کمی لیبرال", fr: "Légèrement libéral", it: "Leggermente liberale" } },
        { value: "Moderate / Middle of the road", label: { en: "Moderate / Middle of the road", ar: "معتدل / في الوسط", fa: "میانه‌رو", fr: "Modéré / Neutre", it: "Moderato / Neutrale" } },
        { value: "Slightly conservative", label: { en: "Slightly conservative", ar: "محافظ إلى حد ما", fa: "کمی محافظه‌کار", fr: "Légèrement conservateur", it: "Leggermente conservatore" } },
