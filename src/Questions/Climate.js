const Climate = [
  ...
  },
  {
    ...
    },
    {
      id: 37,
      question: {
          en: "How much do you think global warming will harm plants and animal species?",
          ar: "إلى أي مدى تعتقد أن الاحتباس الحراري سيؤذي النباتات والحيوانات؟",
          fa: "فکر می‌کنید گرم شدن زمین چقدر به گیاهان و گونه‌های جانوری آسیب خواهد رساند؟",
          fr: "À quel point pensez-vous que le réchauffement climatique nuira aux plantes et aux espèces animales ?",
          it: "Quanto pensi che il riscaldamento globale danneggerà le piante e le specie animali?"
      },          
      options: [
        {
          value: "A great deal",
